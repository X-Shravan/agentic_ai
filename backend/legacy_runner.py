...
from backend.agents.behavior_analysis_agent import BehaviorAnalysisAgent
...
from backend.agents.role_classification_agent import RoleClassificationAgent
from backend.agents.surveillance_agent import DemoSurveillanceAgent, SurveillanceAgent
from backend.agents.tracking_agent import TrackingAgent
from backend.agents.evidence_agent import EvidenceCapture
from backend.agents.hardware_alert import HardwareAlert
from backend.utils.alert_utils import alert_message


class ExamSurveillanceSystem:
    def __init__(self, config_path="backend/core/config.yaml", demo_mode=False):
        ...
        self.evidence = EvidenceCapture(
            self.config.get("alerts", {}).get("evidence_dir", "backend/evidence")
        )
...
def main():
    ...
    parser.add_argument("--config", default="backend/core/config.yaml")
